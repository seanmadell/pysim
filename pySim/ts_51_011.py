...
class DF_CUSTOM(CardDF):
    def __init__(self, fid='7fff', name='DF.CUSTOM', desc='Custom Network related files'):
        super().__init__(fid=fid, name=name, desc=desc)
        files = [
          EF_LP(),
          EF_IMSI(),
...
class CardProfileSIM(CardProfile):
    def __init__(self):
        super().__init__('SIM', desc='GSM SIM Card', files_in_mf=[DF_TELECOM(), DF_GSM(), DF_CUSTOM()])
